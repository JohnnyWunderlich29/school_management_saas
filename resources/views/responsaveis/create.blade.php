                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        <x-input type="text" name="cep" label="CEP *" :value="old('cep')" required
                            placeholder="00000-000" id="cep" maxlength="9" class="pr-12"
                            help="Digite o CEP e clique na lupa para buscar.">
                            <button type="button" id="btn-buscar-cep-resp-create"
                                ...
                                <svg id="icon-cep-resp-create" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="flex flex-col gap-2 items-start justify-between">
                        <div class="flex flex-row gap-4 items-center">
                            <h6 class="block text-sm font-medium text-gray-700 mb-1">É o principal contato de emergência?
                            </h6>
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="hidden" name="contato_emergencia" value="0" />
                                <input type="checkbox" name="contato_emergencia" value="1" checked
                                    class="sr-only peer" />
                                <div
                        ...
                        <div class="flex flex-row gap-4 items-center mt-2">
                            <h6 class="block text-sm font-medium text-gray-700 mb-1">Principal contato para buscar aluno?
                            </h6>
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="hidden" name="autorizado_buscar" value="0" />
                                <input type="checkbox" name="autorizado_buscar" value="1" checked
                                    class="sr-only peer" />
                                <div
                                    class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-3 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600">
                                </div>
                        ...
                        <div class="flex flex-row gap-4 items-center mt-2">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="consolidate_billing" value="1" class="sr-only peer" />
                                <div
