            ...
            <form action="{{ route('escalas.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Normal" {{ old('tipo_escala') == 'Normal' ? 'selected' : '' }}>Normal</option>
                                <option value="Extra" {{ old('tipo_escala') == 'Extra' ? 'selected' : '' }}>Extra</option>
                                <option value="Substituição" {{ old('tipo_escala') == 'Substituição' ? 'selected' : '' }}>Substituição</option>
                            </x-select>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                <option value="">Selecione o tipo</option>
                                <option value="em_sala" {{ old('tipo_atividade') == 'em_sala' ? 'selected' : '' }}>Em Sala</option>
                                <option value="pl" {{ old('tipo_atividade') == 'pl' ? 'selected' : '' }}>PL (Planejamento)</option>
                                <option value="ausente" {{ old('tipo_atividade') == 'ausente' ? 'selected' : '' }}>Ausente</option>
                            </x-select>
                        </div>
                ...
                <div class="flex justify-end space-x-3 pt-4 border-t">
                    ...
                    <x-button type="submit" color="primary">
                        <i class="fas fa-save mr-1"></i> Criar Escala
                    </x-button>
                </div>
            </form>
</div>
