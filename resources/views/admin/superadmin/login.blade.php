    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-300">
                Acesso exclusivo para super administradores do sistema
            </p>
        </div>
        
        <form class="mt-8 space-y-6" action="{{ route('corporativo.login') }}" method="POST">
            @csrf
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                <div>
                    ...
                    <input id="email" name="email" type="email" autocomplete="email" required 
                           ...
                           placeholder="Email do super administrador" value="{{ old('email') }}">
                </div>
                <div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                    <a href="{{ route('admin.login') }}" class="font-medium text-red-400 hover:text-red-300">
            ...
            <div class="text-center">
                <p class="text-xs text-gray-400">
                    ⚠️ Área restrita - Apenas super administradores autorizados
                </p>
            </div>
        </form>
    </div>
