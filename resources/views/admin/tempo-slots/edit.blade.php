...
@section('title', 'Editar Tempo Slot - ' . $tempoSlot->nome)
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Editar Tempo Slot</h1>
            <p class="text-muted mb-0">{{ $tempoSlot->nome }} - Turno: {{ $turno->nome }}</p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.turnos.tempo-slots.update', [$turno, $tempoSlot]) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('tipo') is-invalid @enderror" id="tipo" name="tipo" required>
                                    ...
                                    @foreach($tipos as $valor => $label)
                                        <option value="{{ $valor }}" {{ old('tipo', $tempoSlot->tipo) == $valor ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="time" 
                                       ...
                                       id="hora_inicio" 
                                       name="hora_inicio" 
                                       value="{{ old('hora_inicio', $tempoSlot->hora_inicio) }}" 
                                       required>
                                @error('hora_inicio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="time" 
                                       ...
                                       id="hora_fim" 
                                       name="hora_fim" 
                                       value="{{ old('hora_fim', $tempoSlot->hora_fim) }}" 
                                       required>
                                @error('hora_fim')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('duracao_minutos', $tempoSlot->duracao_minutos) }}" 
                                       min="1"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="ordem" 
                                       name="ordem" 
                                       value="{{ old('ordem', $tempoSlot->ordem) }}" 
                                       min="1"
                                       required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           name="ativo" 
                                           value="1" 
                                           {{ old('ativo', $tempoSlot->ativo) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('descricao') is-invalid @enderror" 
                                      ...
                                      name="descricao" 
                                      rows="3" 
                                      placeholder="Descrição opcional do tempo slot">{{ old('descricao', $tempoSlot->descricao) }}</textarea>
                            @error('descricao')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Atualizar Tempo Slot
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h6 class="card-title mb-0">Informações Atuais</h6>
                </div>
                <div class="card-body">
                    <dl class="row">
                        <dt class="col-sm-5">Tipo:</dt>
                        <dd class="col-sm-7">
                            <span class="badge bg-{{ $tempoSlot->tipo === 'aula' ? 'primary' : ($tempoSlot->tipo === 'intervalo' ? 'warning' : 'info') }}">
                                {{ $tempoSlot->tipo_formatado }}
                            </span>
                        </dd>
                        
                        <dt class="col-sm-5">Duração:</dt>
                        <dd class="col-sm-7">{{ $tempoSlot->duracao_minutos }} min</dd>
                        
                        <dt class="col-sm-5">Status:</dt>
                        <dd class="col-sm-7">
                            <span class="badge bg-{{ $tempoSlot->ativo ? 'success' : 'secondary' }}">
